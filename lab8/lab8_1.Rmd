...
> **For Big-Data Scientists, "Janitor Work" Is a Key Hurdle to Insights.**  
...
heartrate %>% 
  pivot_longer(-patient,
               names_to = "drug", #column names go here
               values_to = "heartrate" #values go here
               )
```
...
relig_income %>% 
  pivot_longer(-religion,
               names_to = "income_level", #column names go here
               values_to = "number" #values go here
               )
```
